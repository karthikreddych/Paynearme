    ...
    function save() {
	  ...
	  payload['arguments'].execute.inArguments = [{
	        ...
	        "requester": "{{Contact.Attribute.PNMSMSDE.requester}}",
                ...
                "categoryName": eval("(function() { if('{{Contact.Attribute.PNMSMSDE.eventType}}'==''){payload['arguments'].execute.inArguments[0].categoryName="+TemplateNameValue+"}else{payload['arguments'].execute.inArguments[0].categoryName= '{{Contact.Attribute.PNMSMSDE.eventType}}';)()"),		"communicationChannel": "{{Contact.Attribute.PNMSMSDE.communicationChannel}}",
