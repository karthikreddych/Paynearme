...
payload['arguments'].execute.inArguments = [{
	        ...
	        "requester": "{{Contact.Attribute.PNMSMSDE.requester}}",
                ...
                "categoryName": ('{{Contact.Attribute.PNMSMSDE.eventType}}'===null || '{{Contact.Attribute.PNMSMSDE.eventType}}'==="" || '{{Contact.Attribute.PNMSMSDE.eventType}}'==="undefined") ? TemplateNameValue : '{{Contact.Attribute.PNMSMSDE.eventType}}',
